  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white">
      ...
      <div className="text-center py-24 px-6">
        <div className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 px-4 py-2 rounded-full text-green-600 dark:text-green-400 text-sm mb-8">
          <Brain size={14} /> Powered by Sakafu AI
        </div>
        <h1 className="text-6xl font-bold mb-6 leading-tight">
          Your Forex Journal<br />
          <span className="text-green-600 dark:text-green-400">With AI Intelligence</span>
        </h1>
      ...
      <div className="grid md:grid-cols-4 gap-6 px-10 pb-20">
        {[
          ...
          <div key={title} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl">
